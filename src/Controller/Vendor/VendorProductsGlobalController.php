...
class VendorProductsGlobalController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        return $this->render('vendors/products_global.html.php', $data);
    }
    ...
    public function product(int $id): ControllerResponseInterface
    {
        ...
        $relatedProducts = $db->query("
            ...
            LIMIT 4
        ");
        $data['relatedProducts'] = $relatedProducts === false ? [] : $relatedProducts;

        return $this->render('vendors/product_global.html.php', $data);
    }
