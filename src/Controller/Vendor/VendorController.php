...
class VendorController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        $sqlGetUser = "SELECT * FROM vendors WHERE id = {$userId} LIMIT 1";
        $result = $dbConnection->query($sqlGetUser);

        $userData = $result[0];
        $data['user_data'] = $userData;

        return $this->render('vendors/profile.html.php', $data);
    }
    ...
    public function edit(): ControllerResponseInterface
    {
        ...
        return $this->render('vendors/profile_edit.html.php', $data);
    }
