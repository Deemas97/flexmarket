...
class VendorCompanyController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        return $this->render('vendors/company.html.php', $data);
    }

    public function edit(int $id): ControllerResponseInterface
    {
        $this->checkAuth();
        ...
        return $this->render('vendors/admin_company_edit.html.php', $data);
    }
