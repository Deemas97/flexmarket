...
class VendorCustomersController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        return $this->render('vendors/customers.html.php', $data);
    }
    ...
    public function customer(int $id): ControllerResponseInterface
    {
        ...
        return $this->render('vendors/customer.html.php', $data);
    }
