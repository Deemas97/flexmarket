...
class VendorOrdersPositionsController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        $companyId = $db->query("SELECT company_id FROM vendors AS v WHERE v.id = {$userId}")[0]['company_id'];
        ...
        return $this->render('vendors/orders_positions.html.php', $data);
    }
