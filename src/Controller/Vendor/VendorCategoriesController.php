...
class VendorCategoriesController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        return $this->render('vendors/categories.html.php', $data);
    }
    ...
    public function category(int $id): ControllerResponseInterface
    {
        ...
        return $this->render('vendors/category.html.php', $data);
    }
