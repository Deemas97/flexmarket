...
class VendorReportsController extends ControllerRendering
{
    private array $statusConfig = [
        'order' => [
            'pending' => ['color' => '#4e73df', 'text' => 'Ожидание'],
            'processing' => ['color' => '#36b9cc', 'text' => 'В обработке'],
            'shipped' => ['color' => '#1cc88a', 'text' => 'Отправлено'],
            'delivered' => ['color' => '#f6c23e', 'text' => 'Доставлено'],
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        return $this->render('vendors/reports.html.php', $data);
    }
