...
class VendorAcceptancesController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        return $this->render('vendors/acceptances.html.php', $data);
    }
    ...
    public function acceptance(int $id): ControllerResponseInterface
    {
        ...
        return $this->render('vendors/acceptance_edit.html.php', $data);
    }
