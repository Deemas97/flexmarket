...
class CustomerCompaniesController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        return $this->render('customers/companies.html.php', $data);
    }
    ...
    public function company(int $id): ControllerResponseInterface
    {
        ...
        return $this->render('customers/company.html.php', $data);
    }
