...
class CustomerSearchController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        return $this->render('customers/search.html.php', $data);
    }
    ...
    private function performSearch(string $query): array
    {
        ...
        foreach ($products as $product) {
            $results[] = [
                ...
                'url' => "/customer/product/{$product['id']}/edit",
                'image_main' => "/customer/product/{$product['image_main']}",
                'meta' => [
        ...
        foreach ($categories as $category) {
            $results[] = [
                ...
                'url' => "/customer/category/{$category['id']}",
                'image' => "/customer/category/{$category['image']}"
            ];
        }
        ...
        foreach ($companies as $company) {
            $results[] = [
                ...
                'url' => "/customer/company/{$company['id']}",
                'image' => "/customer/company/{$company['image']}"
            ];
        }
