...
class CustomerController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        $sqlGetUser = "SELECT * FROM customers WHERE id = {$userId} LIMIT 1";
        $result = $dbConnection->query($sqlGetUser);

        $userData = $result[0];
        $data['user_data'] = $userData;

        return $this->render('customers/profile.html.php', $data);
    }
    ...
    public function edit(): ControllerResponseInterface
    {
        ...
        return $this->render('customers/profile_edit.html.php', $data);
    }
