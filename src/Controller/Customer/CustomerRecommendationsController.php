...
class CustomerRecommendationsController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        $data['personal_recommended_products'] = $db->query("
            ...
            WHERE pr.customer_id = {$userSessionData['id']} AND p.stock_quantity > 0
        ") ?? [];

        return $this->render('customers/recommendations.html.php', $data);
    }
