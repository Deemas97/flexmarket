...
class CustomerCategoriesController extends ControllerRendering
{
    ...
    public function index(): ControllerResponseInterface
    {
        ...
        return $this->render('customers/categories.html.php', $data);
    }
    ...
    public function category(int $id): ControllerResponseInterface
    {
        ...
        return $this->render('customers/category.html.php', $data);
    }
