                    ...
                    <div class="col">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/customer/profile">Профиль</a></li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="profileForm" enctype="multipart/form-data" action="/api/customer/profile/edit" method="POST">
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="tel" class="form-control" name="phone" 
                                                   value="<?= isset($data['user_data']['phone']) ? $this->escape($data['user_data']['phone']) : '' ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="/customer/profile" class="btn btn-secondary me-2">Отмена</a>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="passwordForm" action="/api/customer/profile/change_password" method="POST">
                                    <div class="mb-3">
