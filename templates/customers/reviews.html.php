                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/customer/product/<?= $this->escape($review['product_id']) ?>/edit"><?= $this->escape($review['product_name']) ?></a></td>
                                        <td><?= $this->escape($review['i'] . ' ' . $review['f']) ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="/customer/review/<?= $review['id'] ?>/edit" class="btn btn-outline-primary" title="Редактировать">
