                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <img src="/<?= $this->escape($data['user_data']['avatar'] ?? 'assets/img/default-avatar.png') ?>" 
                                ...
                                <p class="text-muted mb-3">
                                    <?php if ($data['user_data']['role_id'] === 'subscriber'): ?>
                                        <span class="badge bg-danger">Подписчик</span>
                                    <?php else: ?>
                                        <span class="badge bg-primary">Базовый</span>
                                    <?php endif; ?>
                                </p>
                            </div>
                        </div>
