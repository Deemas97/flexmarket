                    ...
                    <div class="col">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/vendor/products">Товары</a></li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <form id="editProductForm" action="/api/vendor/product/<?= $data['product']['id'] ?>/edit" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-2">
                                            <div class="position-relative" style="width: 200px;">
                                                <img src="http://crm.flexmarket.local/uploads/images/products/main/<?= $this->escape($data['product']['image_main']) ?>" 
                                                     alt="Текущее изображение" 
                                                     class="img-thumbnail cursor-zoom"
                                                     style="max-height: 200px;"
                                                     data-bs-toggle="modal" 
                                                     data-bs-target="#imageModal"
                                                     data-img-src="http://crm.flexmarket.local/uploads/images/products/main/<?= $this->escape($data['product']['image_main']) ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="/vendor/products" class="btn btn-secondary me-2">Отмена</a>
