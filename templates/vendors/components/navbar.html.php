    ...
    <div class="container-fluid navbar-container">
        ...
        <div class="navbar-top-row w-100 d-flex justify-content-center align-items-center py-2">
            <div class="d-flex align-items-center justify-content-between navbar-top-content" style="width: 100%; max-width: 1200px;">
                ...
                <div class="d-flex align-items-center">
                    <a class="navbar-brand" href="/vendor/main">
                        <img src="/assets/img/logo.png" alt="CRM Logo" height="40">
                        <span class="ms-2 brand-text d-none d-sm-inline">ФлексМаркет / Вендор</span>
                    </a>
                </div>
                
                <!-- Поиск (центрированный) -->
                <div class="flex-grow-1 mx-3" style="max-width: 600px;">
                    <form class="input-group crm-search" action="/vendor/search" method="GET">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        ...
                        <li><a class="dropdown-item" href="/vendor/profile"><i class="fas fa-user me-2"></i>Профиль</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="/api/vendor/logout"><i class="fas fa-sign-out-alt me-2"></i>Выход</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="navbar-bottom-row w-100 py-2">
            <div class="d-flex justify-content-center">
                <div class="navbar-nav nav-links-container" style="max-width: 1200px; width: 100%;">
                    <a class="nav-link px-3 nav-white" href="/vendor/main"><i class="fas fa-home me-1 d-none d-md-inline"></i> Главная</a>
                    <a class="nav-link px-3 nav-white" href="/vendor/products_global"><i class="fas fa-list me-1 d-none d-md-inline"></i> Каталог</a>
                    <a class="nav-link px-3 nav-white" href="/vendor/companies"><i class="fas fa-building me-1 d-none d-md-inline"></i> Компании</a>
                </div>
            </div>
        </div>
    </div>
