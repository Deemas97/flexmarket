    ...
    <ul class="nav flex-column">        
        <li class="nav-item">
            ...
            <div class="collapse" id="warehousesMenu">
                <ul class="nav flex-column ps-4">
                    <li class="nav-item">
                        <a class="nav-link" href="/vendor/vendors">
                            <i class="fas fa-users me-2"></i>Сотрудники
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/vendor/companies">
                            <i class="fas fa-flag me-2"></i>Компания
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/vendor/acceptances">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="customersMenu">
                <ul class="nav flex-column ps-4">
                    <li class="nav-item">
                        <a class="nav-link" href="/vendor/customers">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/vendor/reviews">
                            <i class="fas fa-comment me-2"></i>Отзывы
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/vendor/recommendations">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="crmMenu">
                <ul class="nav flex-column ps-4">
                    <li class="nav-item">
                        <a class="nav-link" href="/vendor/reports">
