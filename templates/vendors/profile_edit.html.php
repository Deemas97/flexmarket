                    ...
                    <div class="col">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/vendor/profile">Профиль</a></li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="profileForm" enctype="multipart/form-data" action="/api/vendor/profile/edit" method="POST">
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="/vendor/profile" class="btn btn-secondary me-2">Отмена</a>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="passwordForm" action="/api/vendor/profile/change_password" method="POST">
                                    <div class="mb-3">
