                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <?php if ($position['product_image']): ?>
                                            <img src="http://crm.flexmarket.local/uploads/images/products/main/<?= $this->escape($position['product_image']) ?>" class="rounded me-2" width="40" height="40" alt="<?= $this->escape($position['product_name']) ?>">
                                        <?php endif; ?>
                                        <div>
...
$(document).ready(function() {
    ...
    $('#saveStatusBtn').click(function() {
        ...
        $.ajax({
            url: '/api/vendor/order/' + positionId + '/update_status',
            type: 'POST',
            data: formData,
