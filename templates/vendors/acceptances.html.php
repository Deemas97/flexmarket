                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/vendor/product/<?= $this->escape($acceptance['product_id']) ?>/edit"><?= $this->escape($acceptance['product_name'] ?? 'N/A') ?></a></td>
                                        <td><?= $this->escape($acceptance['count']) ?></td>
                                        <td><?= date('d.m.Y H:i', strtotime($acceptance['created_at'])) ?></td>
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="/vendor/acceptance/<?= $acceptance['id'] ?>/edit" class="btn btn-outline-primary" title="Редактировать">
...
<div class="modal fade" id="addAcceptanceModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="addAcceptanceForm" action="/api/vendor/acceptance/create" method="POST">
...
$(document).ready(function() {
    ...
    $('.delete-acceptance').click(function() {
        ...
        $('#confirmDelete').off('click').on('click', function() {
            $.ajax({
                url: '/api/vendor/acceptance/' + acceptanceId + '/delete',
                method: 'DELETE',
                success: function() {
                    location.reload();
                },
