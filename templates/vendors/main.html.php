                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <div class="category-image" style="background-image: url('<?= $category['image'] ? 'http://crm.flexmarket.local/uploads/images/categories/' . $category['image'] : '/assets/img/image_placeholder.jpg'; ?>');"></div>
                            <div class="card-body">
                                ...
                                <a href="/vendor/category/<?= $category['id'] ?>" class="btn btn-outline-primary">Смотреть товары</a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="product-card card h-100">
                            ...
                            <div class="card-footer bg-transparent">
                                <a href="/vendor/product/<?= $product['id'] ?>" class="btn btn-primary w-100">Подробнее</a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
