...
<?php $this->startSection('content') ?>
            <div class="container-fluid py-4">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-auto">
                        <a href="/vendor/product/create" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="/vendor/product/<?= $product['id'] ?>/edit" class="btn btn-outline-primary" title="Редактировать">
...
$(document).ready(function() {
    ...
    $('.delete-product').click(function() {
        ...
        $('#confirmDelete').off('click').on('click', function() {
            $.ajax({
                url: '/api/vendor/product/' + productId + '/delete',
                method: 'DELETE',
                success: function() {
                    location.reload();
                },
